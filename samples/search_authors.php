...
$url = "https://".$_SERVER['HTTP_HOST']."/authors/?filter=co&order_by=name&order=DESC&api_key=" . MY_AUTH_KEY;
...
$url = "https://".$_SERVER['HTTP_HOST']."/authors/?filter[name]=e&filter[first_name]=l&order_by=name&order=DESC&api_key=" . MY_AUTH_KEY;
